...
ally_lunch = ally_diary.meals.create(:category => "lunch", :calories => 390)
...
ally_meal_food_1 = ally_breakfast.meal_foods.create(:food => chobani, :number_of_servings => 1.5, :calories => 135)
...
ally_meal_food_3 = ally_lunch.meal_foods.create(:food => chobani, :number_of_servings => 1, :calories => 90)
